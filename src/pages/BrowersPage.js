...
export default function BrowersPage(props) {
  ...
  const handleNavigateAddApplicant = () => {
    // navigate('add-borrower')
    // navigate('/add-borrower', { replace: true });
    navigate('/db/add-borrower', { replace: true });
    ...
    <>
      ...
      <Container>
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          ...
          <Button variant="contained" onClick={handleNavigateAddApplicant} startIcon={<Iconify icon="eva:plus-fill" />}>
            New Applicant
          </Button>
        </Stack>
